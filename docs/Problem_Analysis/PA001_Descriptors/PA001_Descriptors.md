# PA001 Problem Analysis on Usage of Descriptors
...
The actual test code is not changed (see the [source code](./pa001_descriptors_test03.py)). And the test **output** is:
